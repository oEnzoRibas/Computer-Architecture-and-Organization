...
Apesar disso, a lógica de SLT deve considerar o resultado da subtração e não apenas o overflow, garantindo que o resultado final seja correto (1) mesmo com overflow, mostrado na figura \ref{fig:Case4} pelo LED SLT-TRUE.
